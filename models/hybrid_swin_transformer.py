...
from models.hybrid_sa import HybridWindowAttention
import pdb
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, employ_hybrid_attn=False):
        super().__init__()
        self.dim = dim
        ...
        self.attn = HybridWindowAttention(
            dim, window_size=to_2tuple(self.window_size), num_heads=num_heads,
            qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop, proj_drop=drop,
            is_hybrid=employ_hybrid_attn)
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 approach_args={}, employ_hybrid_attn=False):
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(dim=dim, input_resolution=input_resolution,
                                 ...
                                 employ_hybrid_attn=employ_hybrid_attn)
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            if i_layer in reverse_attention_locations:
                employ_hybrid_attn = True
            else:
                employ_hybrid_attn = False
