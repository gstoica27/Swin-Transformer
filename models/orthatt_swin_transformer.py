...
from models.orthatt import OrthogonalWindowAttention
import pdb
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, lambda_value=0.):
        super().__init__()
        self.dim = dim
        ...
        self.attn = OrthogonalWindowAttention(
...
class OrthogonalAttnSwinTransformer(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            if i_layer not in reverse_attention_locations:
                bidirectional_lambda_value = 1e10
